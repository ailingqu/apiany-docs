...
| --- | --- |
| `gpt-image-2` | GPT-Image 2 compatible image generation and editing. |
| `nano-banana-pro` | Nano Banana Pro high-fidelity image generation. |
| `nano-banana-2` | Nano Banana 2 high-quality image generation. |
| `nano-banana` | Nano Banana image generation with multiple fallback channels. |
| `z-image` | Fast Z-Image generation with Evolink primary and KIE fallback routing. |
