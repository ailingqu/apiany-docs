---
title: AnythingLLM 연동
description: AnythingLLM에서 APIAny.AI API Key, Base URL 및 권장 모델을 설정합니다.
---
...
![AnythingLLM 설정 스크린샷 1](/images/integrations/anythingllm/main-interface.png)

### 단계 2

![AnythingLLM 설정 스크린샷 2](/images/integrations/anythingllm/llm-provider-selection.png)

### 단계 3

![AnythingLLM 설정 스크린샷 3](/images/integrations/anythingllm/api-configuration.png)
