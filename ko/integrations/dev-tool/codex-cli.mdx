---
title: Codex CLI 연동
description: Codex CLI에서 APIAny.AI API Key, Base URL, 추천 모델을 설정합니다.
---

[Codex CLI](https://github.com/openai/codex)는 환경 변수 또는 로컬 설정 파일을 통해 APIAny.AI에 연결할 수 있습니다. 터미널, 에디터, 자동화된 개발 워크플로에서 사용하기에 적합합니다.
...
터미널을 재시작한 후 `codex`를 실행하거나 다음과 같이 테스트하세요.
