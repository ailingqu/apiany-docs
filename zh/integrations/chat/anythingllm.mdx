---
title: 在 AnythingLLM 中使用 APIAny.AI
description: 在 AnythingLLM 中配置 APIAny.AI API Key、Base URL 和推荐模型。
---
...
![AnythingLLM 配置截图 1](/images/integrations/anythingllm/main-interface.png)

### 步骤 2

![AnythingLLM 配置截图 2](/images/integrations/anythingllm/llm-provider-selection.png)

### 步骤 3

![AnythingLLM 配置截图 3](/images/integrations/anythingllm/api-configuration.png)
