---
title: 在 Codex CLI 中使用 APIAny.AI
description: 在 Codex CLI 中配置 APIAny.AI API Key、Base URL 和推荐模型。
---

[Codex CLI](https://github.com/openai/codex) 可以通过环境变量或本地配置文件连接 APIAny.AI。适合在终端、编辑器和自动化开发流程中使用统一模型接口。
